            ...
            <div class="tw-border-t tw-border-gray-100">
                <dl class="tw-divide-y tw-divide-gray-100">
                    <div class="tw-px-4 tw-py-6 sm:tw-grid sm:tw-grid-cols-3 sm:tw-gap-4 sm:tw-px-6">
                        <dt class="tw-text-sm tw-font-medium tw-text-gray-900">Customer name</dt>
                        <dd class="tw-mt-1 tw-text-sm tw-leading-6 tw-text-gray-700 sm:tw-col-span-2 sm:tw-mt-0">{{ $customer->name }}</dd>
                    </div>
                    <div class="tw-px-4 tw-py-6 sm:tw-grid sm:tw-grid-cols-3 sm:tw-gap-4 sm:tw-px-6">
